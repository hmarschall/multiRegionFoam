...
#include "fieldBoundsNoBoundariesRefinement.H"
...
defineTypeNameAndDebug(fieldBoundsNoBoundariesRefinement, 0);
...
Foam::fieldBoundsNoBoundariesRefinement::fieldBoundsNoBoundariesRefinement
(
    const fvMesh& mesh,
...
Foam::fieldBoundsNoBoundariesRefinement::refinementCellCandidates() const
{
    // Get the field
...
Foam::Xfer<Foam::labelList>
Foam::fieldBoundsNoBoundariesRefinement::unrefinementPointCandidates() const
{
    // Get the field
    const volScalarField& vField =
        mesh().lookupObject<volScalarField>(fieldName_);
