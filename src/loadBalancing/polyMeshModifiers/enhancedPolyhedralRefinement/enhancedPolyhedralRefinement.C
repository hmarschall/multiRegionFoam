...
namespace Foam
{
    defineTypeNameAndDebug(enhancedPolyhedralRefinement, 0);
...
Foam::label Foam::enhancedPolyhedralRefinement::getAnchorLevel
(
    const label faceI
) const
{
...
void Foam::enhancedPolyhedralRefinement::createInternalFaces
(
            ...
            if (pointLevel_[point0] <= cLevel)
            {
                ...
                if (pointLevel_[f[fp1]] <= cLevel)
                {
                    ...
                    if (edgeMidPointI == -1)
                    {
                        ...
                        FatalErrorIn
                        (
                            "enhancedPolyhedralRefinement::createInternalFaces(...)"
...
Foam::label Foam::enhancedPolyhedralRefinement::getAnchorCell
(
    const labelListList& cellAnchorPoints,
    const labelListList& cellAddedCells,
    const label cellI,
...
) const
{
    ...
    if (cellAnchorPoints[cellI].size() > 0)
    {
        ...
        FatalErrorIn("enhancedPolyhedralRefinement::getAnchorCell(...)")
...
void Foam::enhancedPolyhedralRefinement::setNewFaceNeighbours
(
    const labelListList& cellAnchorPoints,
    const labelListList& cellAddedCells,
    const label faceI,
...
Foam::label Foam::enhancedPolyhedralRefinement::findLevel
(
    const face& f,
    const label startFp,
...
) const
{
    ...
    forAll(f, i)
    {
        ...
        {
            FatalErrorIn("enhancedPolyhedralRefinement::findLevel(...)")
                << "face:" << f
...
Foam::label Foam::enhancedPolyhedralRefinement::storeMidPointInfo
(
    const labelListList& cellAnchorPoints,
    const labelListList& cellAddedCells,
    const labelList& cellMidPoint,
...
void Foam::enhancedPolyhedralRefinement::insertEdgeSplit
(
    const labelList& edgeMidPoint,
    const label p0,
    const label p1,
...
void Foam::enhancedPolyhedralRefinement::setRefinementInstruction
(
    polyTopoChange& ref
) const
{
    ...
    else
    {
        ...
        FatalErrorIn
        (
            "enhancedPolyhedralRefinement::setRefinementInstruction(...)"
    ...
    if (debug)
    {
        Pout<< "enhancedPolyhedralRefinement::setRefinementInstruction(...)" << nl
...
//    );
    ...
    if (debug)
    {
        Pout<< "enhancedPolyhedralRefinement::setRefinementInstruction(...)" << endl
    ...
    if (debug)
    {
        ...
        {
            FatalErrorIn("enhancedPolyhedralRefinement::setRefinementInstruction(...)")
...
void Foam::enhancedPolyhedralRefinement::setUnrefinementInstruction
(
    polyTopoChange& ref
) const
{
    ...
    if (refinementLevelIndicator_.size() != mesh_.nCells())
    {
        FatalErrorIn
        (
            "enhancedPolyhedralRefinement::setUnrefinementInstruction(...)"
    ...
    if (debug)
    {
        Pout<< "enhancedPolyhedralRefinement::setUnrefinementInstruction"
            << "(polyTopoChange& ref)"
            << nl
...
Foam::enhancedPolyhedralRefinement::enhancedPolyhedralRefinement
(
    const word& name,
...
void Foam::enhancedPolyhedralRefinement::setCellsToRefine
(
...
)
{
    if (debug)
    {
        Info<< "enhancedPolyhedralRefinement::setCellsToRefine"
...
void Foam::enhancedPolyhedralRefinement::setSplitPointsToUnrefine
(
...
)
{
    if (debug)
    {
        Info<< "enhancedPolyhedralRefinement::setSplitPointsToUnrefine"
