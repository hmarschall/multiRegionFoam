...
namespace Foam
{
    defineTypeNameAndDebug(partitionedControl, 0);
}


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::partitionedControl::read()
{
    dnaCouplingControl::read(true);
}


bool Foam::partitionedControl::criteriaSatisfied()
{
...
Foam::partitionedControl::partitionedControl(fvMesh& mesh)
:
    dnaCouplingControl(mesh, "SIMPLE"),
    initialised_(false)
{
    read();
...
Foam::partitionedControl::~partitionedControl()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::partitionedControl::loop()
{
    read();
