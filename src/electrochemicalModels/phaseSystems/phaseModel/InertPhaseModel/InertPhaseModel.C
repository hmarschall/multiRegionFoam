...
Foam::InertPhaseModel<BasePhaseModel>::Qdot()
{
...
template<class BasePhaseModel>
void Foam::InertPhaseModel<BasePhaseModel>::correctOverpotential()
{}

template<class BasePhaseModel>
void Foam::InertPhaseModel<BasePhaseModel>::correctNernst()
{}
