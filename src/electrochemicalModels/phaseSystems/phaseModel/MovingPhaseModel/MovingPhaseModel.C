...
Foam::MovingPhaseModel<BasePhaseModel>::UEqn()
{
    ...
    Info << "Print average(mag(U_)) " << average(mag(U_)) << endl;
    Info << "Print average(rho) " << average(rho) << endl;

    Info << "Print rho.size() " << rho.size() << endl;
    Info << "Print alpha.size() " << alpha.size() << endl;
    Info << "Print U_.size() " << U_.size() << endl;
    Info << "Print alphaRho.size() " << alphaRho.size() << endl;

    // Info << "Print alphaRhoPhi_ " << alphaRhoPhi_ << endl;
