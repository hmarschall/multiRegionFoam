...
) const
{
    forAll(cellZoneIDs_, zoneI)
    {
        ...
        Info << "Print dZones " << dZones << endl;
        Info << "Print fZones " << fZones << endl;
        ...
        forAll(cells, i)
        {
            ...
            // OF
                ...
                // {
                //     label index = 0;
                //     if (!coordSys_.uniform())            //- coordSys_.uniform(): True if the rotation tensor is uniform for all locations
                //     {
                //         index = i;
                //     }
                //     return index;
                // }
            const label j = 0;  // So the coordSys is assumed to be uniform 
            const tensor Cd =
