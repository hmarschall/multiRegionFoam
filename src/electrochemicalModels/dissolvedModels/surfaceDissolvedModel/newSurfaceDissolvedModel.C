...
Foam::autoPtr<Foam::surfaceDissolvedModel> Foam::surfaceDissolvedModel::New
(
    const fvMesh& mesh,
...
)
{
    ...
    {
        FatalErrorIn("surfaceDissolvedModel::New")
           << "Unknown dissolvedModel type "
           << modelType << endl << endl
           << "Valid surfaceDissolvedModel types are : " << endl
