...
// number of cells per bubble diameter (must be divisible by 2!)
define(cellsDiam, 10)
...
define(c1, calc(cellsCirc/2))
define(c2, calc(fac*cellsDiam/2))
...
blocks
(
   hex (1 8 9 2 5 12 13 6) (c2 c3 1) simpleGrading (go 1 1)
   hex (3 10 11 0 7 14 15 4) (c2 c3 1) simpleGrading (go 1 1)
   hex (0 11 8 1 4 15 12 5) (c2 c1 1) simpleGrading (go 1 1)
);
